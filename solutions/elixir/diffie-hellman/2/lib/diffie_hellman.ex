defmodule DiffieHellman do
  ...
  # Credit to awochna and DoggettCK for demonstrating use of erlang to allow this to be done efficiently.
  def find_remainder_of_power(initial_value, power, divisor),
    do:
      :crypto.mod_pow(initial_value, power, divisor)
