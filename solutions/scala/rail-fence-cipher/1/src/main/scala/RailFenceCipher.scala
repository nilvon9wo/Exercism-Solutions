...
case class Post(var character: String, height: Int, sortOrder: Int) {
  def this(height: Int, sortOrder: Int) {
    this("", height, sortOrder)
  }

  def setCharacter(character: String): Post = {
