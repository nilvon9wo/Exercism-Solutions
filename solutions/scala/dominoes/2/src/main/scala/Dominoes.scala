object Dominoes {
	...
	private def buildAdjacencyMap(
		                             indexed: List[(Domino, Int)]
	                             ): Map[Int, List[AdjacentEdge]] = {
		val empty = Map
			.empty[Int, List[AdjacentEdge]]
