...
def has_ten_value_card(card_one, card_two):
    """Return whether either card has a value of ten."""
    return (is_ten(card_one)
            or is_ten(card_two))

def is_ten(card):
    """Return whether the card has a value of ten."""
    return value_of_card(card) == 10
