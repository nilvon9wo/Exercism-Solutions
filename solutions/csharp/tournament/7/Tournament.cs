...
{
	private static readonly Dictionary<TournamentResult, TournamentResult> resultByOpposite = new()
	{
		{ TournamentResult.Draw, TournamentResult.Draw },
		{ TournamentResult.Loss, TournamentResult.Win },
		{ TournamentResult.Win, TournamentResult.Loss },
	};

	public static TournamentResult ToOpposite(this TournamentResult result) =>
		resultByOpposite[result];
}
