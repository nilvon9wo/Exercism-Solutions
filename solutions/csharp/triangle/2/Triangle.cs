...
public static class EqualityEnumerableExtensions
{
...
public static class DictionaryEnumerableExtensions
{

	public static Dictionary<TKey, int> ToCountDictionary<TCountable, TKey>(
			this IEnumerable<TCountable> records,
			Func<TCountable, TKey> keySelector
		) =>
		records
		.GroupBy(keySelector)
		.Select(value => new
...
public static class NumbericEnumerableExtensions
{
