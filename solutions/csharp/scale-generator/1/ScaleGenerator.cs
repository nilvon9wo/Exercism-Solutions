...
public static class WesternScales
{
	...
	public static List<string> Select(string tonic) =>
		tonic switch
		{
			_ when WesternScales.TonicsFlat.Contains(tonic) =>
					WesternScales.ChromaticsFlat,

			_ when WesternScales.TonicsSharp.Contains(tonic) =>
					WesternScales.ChromaticsSharp,
