...
{
	private static readonly Dictionary<int, string> _verseByNumber = new()
	{
	...
	public static string Recite(int verseNumber) =>
		_verseByNumber.TryGetValue(verseNumber, out string verse)
			? verse
			: throw new ArgumentOutOfRangeException("This verse does not exist", nameof(verseNumber));
